...
:downloadWrapper
set DOWNLOAD_URL="https://repo.maven.apache.org/maven2/org/apache/maven/maven-wrapper/3.7.0-SNAPSHOT/maven-wrapper-3.7.0-SNAPSHOT.jar"

if not "%MVNW_REPOURL%" == "" (
    SET DOWNLOAD_URL="%MVNW_REPOURL%/org/apache/maven/maven-wrapper/3.7.0-SNAPSHOT/maven-wrapper-3.7.0-SNAPSHOT.jar"
)
